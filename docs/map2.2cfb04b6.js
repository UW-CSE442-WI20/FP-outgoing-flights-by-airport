...
var width = 1000;
var height = 500;
var svg = d3.select("#map").insert('svg').attr('width', width).attr('height', height);
var g = svg.append('g'); // Center the Orthographic map on US

var projection = d3.geoOrthographic().rotate([90, -35, 5]);
var path = d3.geoPath().projection(projection); // Source (2) used heavily to display orthographic projection of the data
...
function ready(data) {
  ...
  g.append('g').append('path').attr('d', path(data[0])) //.style("border", "2pix white solid")
  .attr("fill", 'SeaGreen').attr("stroke", "black");
}
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","map2.js"], null)
//# sourceMappingURL=/map2.2cfb04b6.js.map